...
|------|--------|--------|----------|
| 1 | Export all services (~10,340) to JSON | ~5 min | **High** |
| 2 | Compare service plans (old 74 vs new UISP) | ~15 min | **High** |
| 3 | Build PPPoE import using services data | ~1 hour | **High** |
...
| Invoices (~64,301) | Import running (~80% as of Feb 11, 09:00 PHT) |
